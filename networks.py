# What is a Soft Actor Critic? Is a Deep Reinforcement Learning composed by two main neural networks. One of those is
...
# What do we want? Get robots to learn with stability in a continuous space environment

# Why is SAC a good option for our V3S robots? It can learn way faster than the other conventional
...
# How does SAC differ from its pairs? Other than its max-entropy model, there is a very important difference in the
